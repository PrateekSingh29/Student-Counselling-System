    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
                ...
                while (iter.hasNext()) {
                    ...
                    if (item.isFormField()) {
                        ...
                        if (item.getFieldName().equalsIgnoreCase("cmbcountry")) {
                         ...
                         if (item.getFieldName().equalsIgnoreCase("cpwd")) {
                            total = item.getString();
                            //System.out.println("user name : " + uname);
                        }
                    } else {
        ...
        if (status == true) {
            try {
                ...
                String sqlquery = "insert into signup(UserID,Image,uname,pass,FirstName,LastName,Gender,DOB,ContactNo,EmailID,Address,City,PinCode,State,Country,branch,total)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
